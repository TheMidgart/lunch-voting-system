...
public class UserTestData {
    ...
    public static final User USER = new User(USER_ID,"USER","user@gmail.com","{noop}qwerty123");
    public static final User ADMIN = new User(ADMIN_ID,"ADMIN","admin@admin.com","{noop}admin");

    public static final UserTo USER_WITH_NOT_UNIQUE_EMAIL = new UserTo(USER_ID,"ANOTHER_USER",
            "admin@admin.com","(noop)admin");
}
