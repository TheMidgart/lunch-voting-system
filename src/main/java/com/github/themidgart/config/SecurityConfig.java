...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests()
                ...
                .antMatchers("/rest/votes/options**").hasRole(UserRole.USER.name())
                .antMatchers("/rest/votes/*").hasRole(UserRole.USER.name())
                .antMatchers("/rest/votes/admin/results").hasRole(UserRole.ADMIN.name())
